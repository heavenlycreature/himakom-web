...
@section('content')
    <div class="flex lg:bg-gray-100 rounded-xl">
        <form class="w-full max-w-full mx-auto p-6 rounded-xl shadow-md" action="{{ route('journal.update', $journal->slug) }}" enctype="multipart/form-data" method="POST">
            @csrf
            @method('PUT')
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    id="sumber" 
                    name="sumber" 
                    class="text-sm rounded-lg block w-full p-2.5 @error('sumber') bg-red-50 border border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 @else bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 @enderror"  value="{{ old('sumber', $journal->sumber) }}"
                ...
                <div>
                    ...
                    value="{{ old('tujuan', $journal->tujuan) }}"
                    placeholder="Memahami jalur langit.." required />
                    @error('tujuan')
                    <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                        <span class="font-medium">Oh, shibal!</span> {{ $message }}
                    </p>
                ...
                <div>
                    ...
                    value="{{ old('volume', $journal->volume) }}"
                    placeholder="19" 
                    required />
                </div>
                @error('volume')
            ...
            <div class="mt-6 hidden">     
                ...
                <div class="mb-6">            
                    ...
                    {{-- here --}}
                    @if ($pdf)
                    <div id="pdfPreview" class="flex mb-2 p-2 bg-gray-100 rounded items-center justify-between">
                       <div class="flex items-center">
                           ...
                           <span id="pdfName" class="text-sm font-medium">{{ $pdf }}</span>
                       </div>
             ...
             @else 
             <div id="pdfPreview" class="hidden mb-2 p-2 flex bg-gray-100 rounded items-center justify-between">
                <div class="flex items-center">
                    <svg class="w-8 h-8 mr-2" fill="red" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                        <path d="M181.9 256.1c-5-16-4.9-46.9-2-46.9 8.4 0 7.6 36.9 2 46.9zm-1.7 47.2c-7.7 20.2-17.3 43.3-28.4 62.7 18.3-7 39-17.2 62.9-21.9-12.7-9.6-24.9-23.4-34.5-40.8zM86.1 428.1c0 .8 13.2-5.4 34.9-40.2-6.7 6.3-29.1 24.5-34.9 40.2zM248 160h136v328c0 13.3-10.7 24-24 24H24c-13.3 0-24-10.7-24-24V24C0 10.7 10.7 0 24 0h200v136c0 13.2 10.8 24 24 24zm-8 171.8c-20-12.2-33.3-29-42.7-53.8 4.5-18.5 11.6-46.6 6.2-64.2-4.7-29.4-42.4-26.5-47.8-6.8-5 18.3-.4 44.1 8.1 77-11.6 27.6-28.7 64.6-40.8 85.8-.1 0-.1.1-.2.1-27.1 13.9-73.6 44.5-54.5 68 5.6 6.9 16 10 21.5 10 17.9 0 35.7-18 61.1-61.8 25.8-8.5 54.1-19.1 79-23.2 21.7 11.8 47.1 19.5 64 19.5 29.2 0 31.2-32 19.7-43.4-13.9-13.6-54.3-9.7-73.6-7.2zM377 105L279 7c-4.5-4.5-10.6-7-17-7h-6v128h128v-6.1c0-6.3-2.5-12.4-7-16.9zm-74.1 255.3c4.1-2.7-2.5-11.9-42.8-9 37.1 15.8 42.8 9 42.8 9z"/>
                    </svg>
    ...
    // pdf display
        ...
        removePdf.addEventListener('click', function() {
            ...
            // Add a hidden input to indicate that the PDF should be removed
