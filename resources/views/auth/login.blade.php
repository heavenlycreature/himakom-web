...
<section class="bg-white">
  <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
          ...
          <a class="block text-white" href="/">
              ...
              <img src="{{ asset('img/logo/logo.png') }}" alt="" class="h-8 sm:h-10">   
        </a>
        
        <h2 class="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl">
          Selamat Datang di Himpunan Mahasiswa Komputer 💻
        </h2>
      
        <p class="mt-4 leading-relaxed text-white/90">
            Bergabunglah dengan komunitas kami dan temukan kesempatan untuk berkolaborasi, belajar, dan berkembang bersama.
        </p>
            </div>
    </section>
    ...
    class="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6"
      ...
      <div class="max-w-xl lg:max-w-3xl">
        ...
        <div id="error-alert" class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mt-4" role="alert">
            ...
            <span id="close-button" class="absolute top-0 bottom-0 right-0 px-4 py-3 cursor-pointer">
        ...
        <form action="/login" class="mt-8 grid grid-cols-6 gap-6" method="POST">
            @csrf
